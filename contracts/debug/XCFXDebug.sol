...
import "./ERC20Debug.sol";

contract XCFXDebug is ERC20Debug {
    // ======================== configs =========================
    ERC20Debug token;
    address owner;
    ...
    // ======================== constructor =========================
    constructor() ERC20Debug("X-nucleon-CFX", "xCFX") {
        owner = msg.sender;
    }
    ...
    // DEMO FUNCTION - DO NOT USE IN PRODUCTION
    function mintWithoutAffectTotalSupply(address _account, uint256 _value) external lock onlyMinter() {
        _mintWithoutAffectTotalSupply(_account, _value);
    }
